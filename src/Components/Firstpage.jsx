...
export default function Firstpage() {
  ...
  return (
    <>
   <div className="container flex flex-wrap w-4/5 justify-between mx-auto">
    <div className="imagescontainer">
    <img src='./Images/profileimg.png' className='h-screen ' alt='no img'/>
    </div>
<form  onSubmit={handlesubmit}>
  <div className="space-y-12 mt-10">

    <div className="border-b border-gray-900/10 pb-12">
      <h2 className="text-base font-semibold leading-7 text-gray-900">Welcome !!</h2>
      <p className="mt-1 text-xl leading-6 text-black-600 font-extrabold">Sing up to Login </p>
      ...
      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div className="col-span-full">
          ...
          <div className="mt-2">
            <input type="text" name="street-address" id="street-address" autoComplete="street-address" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required/>
          </div>
        </div>
  ...
  <div className="mt-6 flex items-center justify-end gap-x-6">
    ...
    <button type="submit" className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create Account</button>
  </div>
  </div>
</form>
</div>
